...
<title>SSS - Student Sign-in</title>
</head>
<body>
...
<div style="float: left;">
        <img src="img\img12.jpg" width="600px" height="500px" style="margin-top: 30px; margin-left: 50px;">
</div>


<div style="background-image: url('img\\img10.png'); width: 500px;height: 500px; float: right; margin-right: 160px; margin-top: 15px; ">


<form action="StudentLogin" method="post">
<input name="registerNo" type="text" placeholder="Register no." required style="margin-top: 220px;margin-left: 220px;background-color: #FFFFFF;border-radius: 5px;border-width: 0px;width: 200px; height: 40px;"><br><br>
