...
public class GetSubjects extends HttpServlet {
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		      ...
		      out.println("<table> <tr>"+
                      ...
                      "<td style= \"width : 150px;border: 1px ;border-collapse: collapse;border-color: #FFFF99;background-color: #FFFF99;padding: 10px;\"><center> Subject Code </center></td>"+ 
                     ...
                     "<td style= \"width : 100px;border: 1px ;border-collapse: collapse;border-color: #FFFF99;background-color: #FFFF99;padding: 10px;\"><center> Credits </center></td> "+
                      "<td style= \"width : 100px;border: 1px ;border-collapse: collapse;border-color: #FFFF99;background-color: #FFFF99;padding: 10px;\"><center> Grades </center></td> "+
                     "</tr>");
		      for(int i=0;i<a.size();i++)
		      {
		    	  out.println("<tr> <td style=\"width : 70px;border: 1px ;border-collapse: collapse;border-color: #FFFF99;background-color: #FFC0CB;padding: 10px;\">"+ (i+1) +"</td>"
		    	  		+ " <td style= \"width : 150px;border: 1px ;border-collapse: collapse;border-color: #FFFF99;background-color: #FFC0CB;padding: 10px;\"> "+ a.get(i).get(0) +" </td> "
		    	  		...
		    	  		+ "<td style= \"width : 100px;border: 1px ;border-collapse: collapse;border-color: #FFFF99;background-color: #FFC0CB;padding: 10px;\" id = \""+subject_credits.get(i)+"\" name = \""+subject_credits.get(i)+"\" value="+a.get(i).get(2)+"> "+ a.get(i).get(2) +" </td>"
		    	  		+ " <td style= \"width : 100px;border: 1px ;border-collapse: collapse;border-color: #FFFF99;background-color: #FFC0CB;padding: 10px;\"> <select name = \""+no_subject.get(i)+"\" id = \""+no_subject.get(i)+"\" >\r\n <option > select </option>" + 
